...
public class StackArray {
    ...
    // We declare another private field of type int called count to use as our
    // reference variable or pointer.
    private int count;

    // Here we declare our push method and pass it an integer variable named item as
    // a parameter.
    public void push(int item) {
        // If our stack is full and we try to push an item we must use the an if
        // statement.
        // If the number of items is equal to the length of the array then we throw an
        // exception.
        ...
        // Now we set items of count to this new item parameter and increment count by
        // 1.
        // There are two ways to achieve this:
        // 1- items[count] = item;
        // 2- count++;
        // Or we can simply increment count inside the index and take out the 2nd line
        // like so:
        items[count++] = item;
    }

    // Now we implement the pop method in order to remove items from our array
    // Stack.
    ...
    public int pop() {
        // If our stack is empty and we try to pop an item we must use the an if
        // statement.
        ...
        // In order to accomplish this we decrement our count variable by 1 and return
        // its index post decrementing.
        // This can be done in two ways:
        // 1- count--;
        // 2- return items[count];
        // Or we can decrement count inside the index by putting the -- before count
        // like so:
        return items[--count];
    }

    // In order to endure that our implementation is correct we must override the
    // toString() method of this class.
    // Overriding means changing the implementation of a method that we inherit from
    // a base class.
    // In java all classes directly or indirectly inherit from the object class.
    // From example this StackArray class's parent or base class is the Object
    // class.
    // The object class has a toString() method that is inherited in the StackArray
    // class.
    // Here we can change that implementation and return the content of our stack.
    // We do this by creating a toString class that has a String return type and
    // takes in no parameters.
    // We also annotate this method withe override annotation.
    // This tells the java compiler that you are overriding a method inherited from
    // the base class.
    @Override
    public String toString() {
        // We will copy the content of our stack into a separate array and then convert
        // that array into a string.
        // Once again we use the Arrays object and access the copyOfRange() method and
        // pass the items array.
        // We then specify the range of items we want to copy inside the copyOfRange()
        // method.
        // We do this by starting from the index 0 all the way to count which will
        // return a new array as a value.
        // We now store that value inside a variable called content by assigning it the
        // expression above.
        // We do this so we see the exact number of arrays displayed without any empty
        // indexes after we use pop or push.
        var content = Arrays.copyOfRange(items, 0, count);

        // Now we want to return the content of this array represented as a String.
        // We can do this by using the Arrays class and access the toString() method and
        // pass content as our parameter.
        return Arrays.toString(content);
    }

    // Now we implement our peek method which allows us to see the last item in our
    ...
    public int peek() {
        ...
        // This will cause an error so we must throw and exception using an if
        // statement.
        // If the count field/attribute is 0 then we throw a new
